...
Options:
	...
	"type": {
		Command:     "type",
		Description: "Show how the shell resolves a command name",
	...
	"size": {
		Command:     "size",
		Description: "Show file or folder size in a specific unit",
		Usage:       "size <-b|-kb|-mb|-gb|-tb|-pb> <path>",
		Examples: []string{
			"size -b README.md",
			"size -mb ./tools",
			"size -gb /var/log",
	...
	"meta": {
		Command:     "meta",
		Description: "Show file metadata or remove extended metadata",
		Usage:       "meta [-r] <file>",
		Examples: []string{
			"meta image.jpg",
			"meta ./archive.zip",
	...
	"obfu": {
		Command:     "obfu",
		Description: "Obfuscate text and print encoded output",
		Usage:       "obfu <text>",
		Examples: []string{
			"obfu secret",
			"obfu \"token=abc123\"",
	...
	"mini": {
		Command:     "mini",
		Description: "Minify a file in place (HTML, CSS, JS, and plain text)",
		Usage:       "mini <file>",
		Examples: []string{
			"mini app.js",
			"mini styles.css",
